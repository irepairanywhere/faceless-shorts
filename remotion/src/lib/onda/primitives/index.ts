...
// `MotionBlur`/`MotionTrail` are missing from ondajs 0.9.2's own `lib-primitives` template
// (`ondajs add` re-confirms this — it ships Camera/Glow/GridField/Surface only) despite this
// barrel exporting them; dropped rather than stubbing an unused component.
